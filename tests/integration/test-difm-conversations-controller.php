...
class Test_Difm_Conversations_Controller extends WP_UnitTestCase {
	...
	public function test_route_is_registered() {
		...
		$this->assertArrayHasKey( '/hey-woo/v1/difm/conversations', $routes );
	}
	...
	public function test_conversations_require_manage_woocommerce() {
		$request  = new WP_REST_Request( 'GET', '/hey-woo/v1/difm/conversations' );
	...
	private function save_conversation( array $conversation ) {
		$request = new WP_REST_Request( 'POST', '/hey-woo/v1/difm/conversations' );
